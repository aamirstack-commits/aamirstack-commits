...
- Security before features — financial logic is treated as critical infrastructure
- Prefer composable and auditable contracts over monolithic designs
- Optimize gas only after correctness and test coverage
- Maintain production parity between staging and mainnet
- Favor deterministic deployments and clear documentation
